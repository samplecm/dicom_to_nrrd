...
def convert_all_dicoms_to_nrrd(img_dir, struct_dir, modality, subsegmentation=None, save_paths=None):   
    ...
    #Visuals_Subsegs.plotSubsegments(structures_dict["l_par"].segmented_contours_img_planes)
